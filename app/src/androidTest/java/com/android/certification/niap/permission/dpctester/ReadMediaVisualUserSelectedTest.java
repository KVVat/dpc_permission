...
public class ReadMediaVisualUserSelectedTest {
    ...
    public void runPermissionTests(){
        ...
        boolean hasPermissionInManifest = TesterUtils.ensureRequiredPermissions(
                new String[]{Manifest.permission.READ_MEDIA_VISUAL_USER_SELECTED},mInstrumentation.getTargetContext()
        );
        boolean ok = true;
        try {
            ...
            if (checkSelfPermission(mContext, Manifest.permission.READ_MEDIA_VISUAL_USER_SELECTED)
